...
class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/user/register").hasAuthority(PrivilegeAlias.CREATE_USER.getAlias())
                .antMatchers(HttpMethod.GET, "/user/current").authenticated()
                .antMatchers(HttpMethod.POST, "/user").hasAuthority(PrivilegeAlias.MANAGE_USERS.getAlias())
                .antMatchers(HttpMethod.PUT, "/user").hasAuthority(PrivilegeAlias.MANAGE_USERS.getAlias())
                .antMatchers(HttpMethod.POST, "/expense")
                ...
                .hasAnyAuthority(PrivilegeAlias.MANAGE_OWN_RECORDS.getAlias(), PrivilegeAlias.MANAGE_OTHER_RECORDS.getAlias())
                .antMatchers(HttpMethod.PUT, "/expense")
                .hasAnyAuthority(PrivilegeAlias.MANAGE_OWN_RECORDS.getAlias(), PrivilegeAlias.MANAGE_OTHER_RECORDS.getAlias())
